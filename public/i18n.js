...
const STRINGS = {
  en: {
    ...
    'onuw.night.everyoneSameClock': 'Every role is called, whether or not it is in the game, and every step lasts the same time for everyone. You cannot read the deck off the clock.',
...
Evil wins by failing three quests. If good succeeds three times, the Assassin gets one guess at who Merlin is: guess right and evil still wins.`,
  ...
  zh: {
    ...
    'onuw.night.everyoneSameClock': '每个角色都会被叫到,不论是否在场上;每一步对所有人时长相同。所以从节奏上推不出牌堆。',
