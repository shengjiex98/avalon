...
import type { ClientAction, GameId } from '../contracts/actions.ts';
import type { PublicView } from '../contracts/views.ts';
import type { PlayerListOptions } from './renderer-types.ts';
...
/** Expose renderer selection without restoring mutable module bindings. */
